    ...
    translation: {
      ...
      editor: {
        ...
        validation: {
          ...
          basisFilePdfOnly: "Mantiqiy nazorat asosi uchun faqat PDF fayl yuklash mumkin",
    ...
    translation: {
      ...
      editor: {
        ...
        validation: {
          ...
          basisFilePdfOnly: "Only PDF files can be uploaded for the logical control basis",
